...
class BannerVendedor(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        link = f'https://aplicativovendashash-1a58b-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        ...
        imagem = ImageButton(source=f"icones/fotos_perfil/{avatar}",
                             ...
                             on_release=partial(meu_aplicativo.carregar_vendas_vendedor, valores))
        label_id = LabelButton(text=f"Id_vendedor: {id_vendedor}",
